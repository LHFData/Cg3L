...
<html>
<head>
    <title>斯坦福CS231n—深度学习与计算机视觉</title>
    <meta charset="utf-8">
    <meta name="viewport" content="width=device-width, initial-scale=1">
    <title>iLearning-斯坦福CS231n—深度学习与计算机视觉</title>
                ...
                <div class="row">
                    ...
                    <div id="toggle-nav" class="col-xs-12 col-sm-10 col-md-8 col-lg-8 menu-wrapper clearfix">
                        ...
                        <div class="b-header-menu pull-right">
                            <ul class="list-inline">
                                <li>
                                    <a class="heading-line" href="homapage.jsp">主页</a>
    ...
    <section class="section-blog-post">
        ...
        <div class="container">
            <div class="col-sm-12 text-center">
                <h3 class="heading-line text-center">斯坦福CS231n—深度学习与计算机视觉</h3>
            </div>
                    ...
                    <div class="fadeInUp">
                        <div class="post-img-holder">
                            <div class="demo maxvideosize" >
                                ...
                                <%--<iframe src="网页.html" width="80%" height="550" style="border-left: 25px;padding-left: 25px;"></iframe>--%>
                                <div class="post-author pull-left "style="padding-top: 45px;">
